...
#define TOP_FIXED_AREA 10 // Number of lines in top fixed area (lines counted from top of screen)
...
//  tft.drawRect(0, 0, tft.width(), tft.height(), TFT_GREEN);
  ...
  tft.fillRect(0,yStart,tft.width(),TEXT_HEIGHT, TFT_BLACK);
...
void setup() {
  ...
  tft.fillRect(0,0,240,10, TFT_BLUE);
  tft.drawCentreString(" Serial Terminal - 115200 baud ",120,1,1);
...
//        xPos += tft.drawChar(data1,xPos,yDraw,1);
